...
QString HxBlockInfo::gen( QString format, std::shared_ptr<HxLOT> lot, std::shared_ptr<HxModel> model )
{
...
QMap<int, QString> HxBlockInfo::gen( std::shared_ptr<HxDesign> design, std::shared_ptr<HxLOT> lot, std::shared_ptr<HxModel> model )
{
    ...
    {
        if ( num < 1 ) continue;
        HxBlockInfo block = design->blocks[ num ];
